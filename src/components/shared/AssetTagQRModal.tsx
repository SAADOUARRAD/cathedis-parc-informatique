...
export default function AssetTagQRModal({ open, onClose, equipment }: AssetTagQRModalProps) {
  ...
  // The payload encoded into the QR Code (e.g. equipment URL or JSON)
  ...
  const handleDownloadSVG = () => {
    ...
    downloadLink.download = `QR_${equipment.serialNumber || equipment.name}.svg`;
          ...
          <div class="asset-tag">
            ...
            <div class="content">
              ...
              <div class="info">
                ...
                <div class="eq-sn">S/N: ${equipment.serialNumber || 'N/A'}</div>
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="xs" fullWidth slotProps={{ paper: { sx: { borderRadius: 4, overflow: 'hidden' } } }}>
      <DialogTitle sx={{
      ...
      <DialogContent sx={{ pt: 3, pb: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2.5 }}>
        ...
        <Paper elevation={0} sx={{
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '2px solid #E31E24', pb: 1, mb: 2 }}>
            ...
            <Chip label="ACTIF INFORMATIQUE" size="small" sx={{ height: 20, fontSize: '0.65rem', fontWeight: 800, bgcolor: '#FFEBEE', color: '#C62828' }} />
          </Box>

          {/* QR Code & Information */}
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            <Box sx={{
              p: 1, bgcolor: '#fff', borderRadius: 2,
            ...
            <Box sx={{ flex: 1, minWidth: 0 }}>
              ...
              <Typography sx={{ fontSize: '0.75rem', fontFamily: 'monospace', bgcolor: '#F1F5F9', color: '#334155', px: 1, py: 0.3, borderRadius: 1, display: 'inline-block', mt: 0.5, fontWeight: 700 }}>
                S/N: {equipment.serialNumber || 'N/A'}
              </Typography>
              {categoryName && (
